...
def clean_dataset(dataset):
    ...
    LoanStatus_barchart(dataset, 'Loan_Eligibility_Model_Repo\\reports\\figures\\loan_status_barcharts.png')
    ...
    LoanAmount_displot(dataset, 'Loan_Eligibility_Model_Repo\\reports\\figures\\LoanAmount_displots.png')
    ...
    dataset.to_csv("Loan_Eligibility_Model_Repo\\data\\processed\\processed_credit.csv",index=None)
