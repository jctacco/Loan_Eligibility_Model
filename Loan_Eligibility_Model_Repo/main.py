...
df = load_data("Loan_Eligibility_Model_Repo\\data\\raw\\credit.csv")
#cleaning the data
...
with open('Loan_Eligibility_Model_Repo\\models\\logistic_regression.pkl', 'wb') as f:
...
# Save the trained model
with open('Loan_Eligibility_Model_Repo\\models\\decision_tree_classifier.pkl', 'wb') as f:
...
# Save the trained model
with open('Loan_Eligibility_Model_Repo\\models\\random_forest_classifier.pkl', 'wb') as f:
...
with open("Loan_Eligibility_Model_Repo\\models\\" + best_logistic_regression_model_filename, 'wb') as file:
...
with open("Loan_Eligibility_Model_Repo\\" + best_decision_tree_classifier_filename, 'wb') as file:
...
with open("Loan_Eligibility_Model_Repo\\models\\" + best_random_forest_classifier_filename, 'wb') as file:
